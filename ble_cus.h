...
#define R1_CHAR_UUID 0x0013
#define R2_CHAR_UUID 0x0019
#define W1_CHAR_UUID 0x0012
#define N1_CHAR_UUID 0x0014
...
typedef enum {
	...
	BLE_CUS_EVT_NOTIFICATION_ENABLED, /**< Custom value notification disabled event. */
...
struct ble_cus_s {
	...
	ble_gatts_char_handles_t steerer_handles; /**< Handles related to the Custom Value characteristic. */
	ble_gatts_char_handles_t r1_handles; /**< Handles related to the Custom Value characteristic. */
	ble_gatts_char_handles_t r2_handles; /**< Handles related to the Custom Value characteristic. */
	ble_gatts_char_handles_t w1_handles; /**< Handles related to the Custom Value characteristic. */
	ble_gatts_char_handles_t n1_handles; /**< Handles related to the Custom Value characteristic. */
	ble_gatts_char_handles_t rx_handles; /**< Handles related to the Custom Value characteristic. */
	ble_gatts_char_handles_t tx_handles; /**< Handles related to the Custom Value characteristic. */
